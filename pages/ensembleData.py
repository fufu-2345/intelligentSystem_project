...
st.write("and use them as a function in this model by give the proper data and collect the result")
st.write("After that, I use hard voting to change the result to be final prediction")
st.write("Here is feature that I use for Train: ")
st.write("CHROM, POS, REF, ALT, AF_ESP, AF_EXAC, AF_TGP, CLNVC, ORIGIN, Allele, IMPACT, CLASS(target column)")
