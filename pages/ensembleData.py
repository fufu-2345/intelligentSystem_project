...
st.write("Hyperparameter: kernel=poly, degree=3, C=2.005")
st.write("SVM efficiency: ")
st.write("The features for this model are: CHROM, POS, ALT, REF, IMPACT, CLASS(target column)")
st.write("SVM efficiency: ")
...
st.write("Hyperparameter: max_depth=15, min_samples_split=10, criterion=entropy")
st.write("The features for this model are: ")
...
st.write("")
st.title("Ensemble")
st.write("I load all the previous models seperately(KNN, SVM, Decision tree)")
st.write("and use them as a function by giving the proper data and collect the result")
st.write("I use hard voting to predict the final result")
st.write("The features for this model are: ")
st.write("CHROM, POS, REF, ALT, AF_ESP, AF_EXAC, AF_TGP, CLNVC, ORIGIN, Allele, IMPACT, CLASS(target column)")
