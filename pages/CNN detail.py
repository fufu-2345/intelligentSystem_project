...
st.write("CNN efficiency:")
st.image("imgs/cnnResult.png")
st.write("")
st.write("")
st.title("This model can predict only some of the characters in the game")
st.write("Here is the list of the characters")
